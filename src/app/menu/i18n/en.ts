  ...
  data: {
    MENU: {
      ...
      UI: {
        ...
        TYPOGRAPHY: 'Gestion Runsheet',
        COLORS: 'Gestion Hub',
        FEATHER: 'Liste retour',
        CARDS: {
          COLLAPSIBLE: 'Cards',
          BADGE: 'New',
          BASIC: 'Basic',
      ...
      FT: {
        ...
        LAYOUTS: 'Colis Crées',
        WIZARD: 'Ajouter Colis',
        VALIDATION: 'Gestion Colis',
        REPEATER: 'Gestion personnel',
        TABLE: 'Gestion Fournisseurs',
        DATATABLES: 'Gestion des Colis'
      },
      CM: {
        SECTION: 'Charts & Maps',
        CHARTS: {
