...
// @Component({
//   selector: 'app-a-enleve',
//   templateUrl: './a-enleve.component.html',
//   styleUrls: ['./a-enleve.component.scss']
// })
// export class AEnleveComponent implements OnInit {
...
export class AEnleveComponent implements OnInit {
  ...
  listEtat = [
    { value: 'cree', viewValue: 'Crée' }, { value: 'enStock', viewValue: 'En Stock' }, { value: 'enAttenteDEnlevement', viewValue: "En Attente D'enlevement" }, { value: 'enleve', viewValue: "enlevé" }
  ...
  public listColisAEnleve: any[]; // Déclaration de la liste des colis "aenleve"
  ...
  ngOnInit() {
    ...
    this.colisService.getColisaenleve(this.fournisseurID).subscribe(response => {
      this.rows = response;
      
      this.tempData = this.rows;
      this.listColisCrees = this.rows;
      this.exportCSVData = this.rows;
      //this.listColisAEnleve = this.listColisCrees.filter(colis => colis.etat === 'aenleve');
